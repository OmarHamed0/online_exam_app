...
import '../feature/home_layout/domain/use_case/profile/get_profile_data_use_case.dart'
    as _i712;
import '../feature/home_layout/domain/use_case/profile/update_profile_data_use_case.dart'
    as _i813;
import '../feature/home_layout/presentation/view_model/explore/explore_cubit.dart'
    as _i19;
import '../feature/home_layout/presentation/view_model/home_loyout/home_layout_cubit.dart'
    as _i210;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i210.MainHomeCubit>(() => _i210.MainHomeCubit());
    ...
    gh.factory<_i813.UpdateProfileDataUseCase>(() =>
        _i813.UpdateProfileDataUseCase(
            profileRepository: gh<_i323.ProfileRepository>()));
    gh.factory<_i394.ProfileCubit>(() => _i394.ProfileCubit(
          gh<_i712.GetProfileDataUseCase>(),
          gh<_i813.UpdateProfileDataUseCase>(),
        ));
    return this;
  }
}

...
import 'package:online_exam/feature/auth/presentation/forget_password/widget/reset_password_widget/reset_password_widget.dart';
...
import '../../feature/home_layout/presentation/view/home_layout_view.dart';
import '../../feature/home_layout/presentation/widget/profile/reset_password_widget.dart';
class AppRoutes {
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case PageRouteName.resetPassword:
        return _handleMaterialPageRoute(widget:  const ResetPassword());

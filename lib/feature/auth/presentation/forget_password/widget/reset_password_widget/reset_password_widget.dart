...
class ResetPasswordWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<ForgetPasswordCubit, ForgetPasswordState>(
      ...
      child: Column(
        ...
        children: [
          Text(
            resetPasswordCubit.appLocalizations!.rePassword,
         ...
         Form(
           ...
           onChanged: () => resetPasswordCubit.doAction(UpdateValidationEvent()),
           child: CustomTextFromField(
           controller:resetPasswordCubit.newPasswordController,
          hintText: resetPasswordCubit.appLocalizations!.newPassword,
          labelText: resetPasswordCubit.appLocalizations!.enterNewPassword,
  ...
  void _handleStateChange(BuildContext context , ForgetPasswordState state){
    ...
    {
      Navigator.pop(context);
      AppDialogs.showErrorDialog(context: context,
